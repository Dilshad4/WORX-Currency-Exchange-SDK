...
- **الخطة المجانية**: طلب واحد في الدقيقة
- **خطة برو**: طلبان في الدقيقة
- **خطة بلاتينية**: 3 طلبات في الدقيقة

معلومات حد المعدل متاحة في رؤوس الاستجابة وتفاصيل الخطأ.

## خطط الاشتراك

- **مجانية**: 24 استدعاء API يومياً، واحد في الساعة، حتى 5 عملات مراقبة
- **برو**: 1500 استدعاء API يومياً، اثنان في الدقيقة، حتى 5 عملات مراقبة، 15$/شهر
- **بلاتينية**: 2500 استدعاء API يومياً، 3 في الدقيقة، webhooks غير محدودة، حتى 25 عملة مراقبة، 35$/شهر
