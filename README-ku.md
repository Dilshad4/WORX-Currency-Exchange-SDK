...
- 🎯 **بەڕێوەبردنی بەشداریکردن** - پشتگیری پلانی خۆڕایی، پڕۆ، و پلاتینی
...
- **پلانی خۆڕایی**: داواکاریەک لە خولەکێکدا
- **پلانی پڕۆ**: دوو داواکاری لە خولەکێکدا
- **پلانی پلاتینی**: 3 داواکاری لە خولەکێکدا

زانیاری سنووری نرخ لە سەری وەڵام و وردەکاری هەڵەکاندا بەردەستە.

## پلانەکانی بەشداریکردن

- **خۆڕایی**: 24 بانگکردنی API ڕۆژانە، یەک لە کاتژمێرێکدا، تا 5 دراوی چاودێریکراو
- **پڕۆ**: 1500 بانگکردنی API ڕۆژانە، دووان لە خولەکێکدا، تا 5 دراوی چاودێریکراو، $15/مانگ
- **پلاتینی**: 2500 بانگکردنی API ڕۆژانە، 3 لە خولەکێکدا، webhook بێسنوور، تا 25 دراوی چاودێریکراو، $35/مانگ
